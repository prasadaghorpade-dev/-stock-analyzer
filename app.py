...
# ---------------------------------------------------------------
    ...
    if analyze_btn:
        ...
        if data is not None and not data.empty:
            ...
            st.markdown("---")
            st.markdown("#### Quick P&L Snapshot & Trade")
            ...
            with qt4:
                ...
                if st.button("Quick Sell"):
                    if quick_qty > shares_held_quick:
                        ...
                        st.rerun()
            st.caption(f"Virtual cash available: Rs {st.session_state.paper_cash:,.2f}. Full trade history and stop-loss/target tools are in the Paper Trading tab below.")
            st.markdown("---")
